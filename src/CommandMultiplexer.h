...
public:
  ...
  explicit CommandMultiplexer(double staleSeconds = 0.5, double motionEpsilon = 1e-4);
...
private:
  ...
  bool isFresh(const std::optional<StampedCommand>& input, const rclcpp::Time& now) const;
