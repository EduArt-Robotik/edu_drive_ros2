...
/**
 * @class Matrix
 * @brief Simple matrix algebra to avoid the binding to 3rd party libraries. This class is capable of inverting kinemtic
 * matrices as used in our drive stack.
 * @author Stefan May
 * @date 29.01.2025
 */
class Matrix
